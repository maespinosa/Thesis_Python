...
accumulate_first_kernel = single(sum(multiplied_first_kernel,1)) 
...
accumulate_second_kernel = single(sum(multiplied_second_kernel,1)) 
...
accumulate_third_kernel = single(sum(multiplied_third_kernel,1)) 
...
check = conv2(image_data(1:11,1:11,1),W1_single(1:11,1:11,1,1),'valid') + conv2(image_data(1:11,1:11,2),W1_single(1:11,1:11,2,1),'valid')+conv2(image_data(1:11,1:11,3),W1_single(1:11,1:11,3,1),'valid')
check2 = filter2(image_data(1:11,1:11,1),W1_single(1:11,1:11,1,1),'valid') + filter2(image_data(1:11,1:11,2),W1_single(1:11,1:11,2,1),'valid')+filter2(image_data(1:11,1:11,3),W1_single(1:11,1:11,3,1),'valid')
