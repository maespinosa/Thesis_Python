...
sys.path.append('C:/Users/Marks-M3800/AppData/Local/Programs/Python/Python35/Lib/site-packages')
import time
...
def clear_files():
	...
	if os.path.exists('C:/Users/Marks-M3800/Documents/A_CNN_Model/input_data/'):
		shutil.rmtree('C:/Users/Marks-M3800/Documents/A_CNN_Model/input_data/')

	if not os.path.exists('C:/Users/Marks-M3800/Documents/A_CNN_Model/input_data/'):
		os.makedirs('C:/Users/Marks-M3800/Documents/A_CNN_Model/input_data/')
...
def alexnet_gpu(num_train): 
	...
	loss,params,conv_out,relu_out,max_pool_out, affine_out = gpu_model.loss(X=X, y=y,input_dim = (num_train,3,image_size,image_size), hidden_dim = 4096, num_classes = 1000)
...
def run_compare(): 
	...
	X,y,gpu_loss, gpu_scores, data_loss, avg_data_loss, reg_loss = alexnet_gpu()
...
def run_train(): 
	...
	X,y,gpu_loss,gpu_params,gpu_conv_out,gpu_relu_out,gpu_max_pool_out,gpu_affine_out = alexnet_gpu(num_train)
	#X,y,gpu_loss,params,grads = alexnet_gpu(num_train)
	...
	with tf.Session() as sess: 
		...
		#tf.write_file(filename='C:/Users/Marks-M3800/Documents/A_CNN_Model/W1.txt',contents='hello world')	
		...
		for i in range(1): 
			...
			save_dir = "C:/Users/Marks-M3800/Documents/A_CNN_Model/input_data/"
			x_train, y_train, y_train_name = Train_Net.get_train_data(num_train=num_train, save_location=save_dir)
			print('x_train shape = ', x_train.shape)
			print('y_train shape = ', y_train.shape)
			#x_val, y_val = Train_Net.get_val_data(num_val=10)
			#print('y_train = ', y_train)
			...
			#tf.Print(loss_val, loss_val, message='loss = ')
				print('Iteration: %d of %d, loss = %f' % (t, 700, avg_loss))
		...
		save_path = affine3_saver.save(sess, "C:/Users/Marks-M3800/Documents/A_CNN_Model/layer_output/affine3.ckpt")
					...
					#save_path = image_saver.save(sess, "C:/Users/Marks-M3800/Documents/A_CNN_Model/input_data/input_image_data.ckpt")
